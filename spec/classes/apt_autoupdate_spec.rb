...
describe 'apt_autoupdate' do
  ...
  describe 'with autoupdate option set to true' do
    let(:params) { required_params.merge({ :autoupdate => true }) }
  ...
  describe 'for operating system family unsupported' do
    ...
    it { expect{ subject }.to raise_error(/^The apt_autoupdate module is not supported on unsupported based systems/)}
  end
